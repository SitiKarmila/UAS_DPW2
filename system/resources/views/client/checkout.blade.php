            ...
            <div class="col-md-12">
              ...
              <div class="p-3 p-lg-5 border">
                <table class="table site-block-order-table mb-5">
                  ...
                  <tbody>
                    <tr>
                      <td>Clotted cream<strong class="mx-2">x</strong> 1</td>
                      <td>RP. 40.000</td>
                    </tr>
                    <tr>
                      <td>Paletas Cone<strong class="mx-2">x</strong>   1</td>
                      <td>RP. 29.000</td>
                    </tr>
                    <tr>
                      <td class="text-black font-weight-bold"><strong>Cart Subtotal</strong></td>
                      <td class="text-black">RP. 69.000</td>
                    </tr>
                    <tr>
                      <td class="text-black font-weight-bold"><strong>Order Total</strong></td>
                      <td class="text-black font-weight-bold"><strong>RP. 69.000</strong></td>
                    </tr>
                  </tbody>
                </table>
